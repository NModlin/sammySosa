# SAM.gov AI Automation System - Phase 2: Web Dashboard
# This script uses Streamlit to create an interactive web interface
# for viewing and filtering the contract opportunities in your PostgreSQL database.
...
st.title("SAM.gov Contract Opportunities Dashboard")
st.write("This dashboard displays the latest government contract opportunities fetched by the automated scraper.")

# Load the data from the database
df = load_data()

if df.empty:
    st.warning("No data found. Please run the scraper script (sam_gov_scraper_phase1_v4.py) to populate the database.")
else:
    # --- SIDEBAR FOR FILTERS ---
