# DEPRECATED: Phase 1 scraper is consolidated into govcon_suite.py
...
def setup_database():
    ...
    try:
        ...
        opportunities = Table('opportunities', metadata,
            ...
            Column('status', String, default='New', nullable=False), # Internal workflow tracking
...
if __name__ == "__main__":
    print("--- Starting SAM.gov Opportunity Scraper (LEGACY) ---")
    ...
    print("--- Scraper run finished. (LEGACY) ---")
